...
class GenreLSTM(object):
    ...
    def train(self, data, model=None, starting_epoch=0, clip_grad=False, epochs=1001, input_keep_prob=1.0, output_keep_prob=1.0, learning_rate=0.0001, eval_epoch=50):
